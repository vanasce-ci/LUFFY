...
- [ ] **luffy/verl/verl/models/llama/megatron/modeling_llama_megatron.py:37** - Add weight initialization. Here we need to be careful on TP weight init.; Add sequence parallel; Load checkpoint from meta LLama pretrained checkpoint
